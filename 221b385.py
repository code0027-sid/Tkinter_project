...
class main_fn:
    def front(self):
        ...
        Label(root,text='Online Bus Booking System',fg='white',bg='green',font="Arial 24 bold").pack()

        Label(root,text='Name : SIDDHARTH SINGH GAUR',fg='black',font="Arial 11 bold",pady=25).pack()

        Label(root,text='Er : 221B385',fg='black',font="Arial 11 bold",pady=25).pack()

        Label(root,text='Mobile :  7710029428',fg='black',font="Arial 11 bold",pady=25).pack()

        Label(root,text='Submitted to : Dr. Mahesh Kumar ',fg='white',bg='green',font="Arial 15 bold").pack()

        Label(root,text='Project Based Learning',fg='black',font="Arial 13 bold").pack()
    ...
    def menu(self):
        ...
        Label(root,text='Online Bus Booking System',fg='black',bg='green',font="Arial 24 bold",borderwidth=1,relief="ridge").grid(row=1,column=0,padx=400,columnspan=7,pady=40)
        ...
        admin=Label(root,text="For Admin Only",fg="blue",font="Arial 12 bold").grid(row=7,column=3,columnspan=4)
    ...
    def booking(self):
        ...
        Label(root,text='Online Bus Booking System',fg='black',bg='green',font="Arial 24 bold",borderwidth=1,relief="ridge").grid(row=1,column=0,padx=400,columnspan=7,pady=10)
        ...
        def book():
            ...
            Label(Frame3,text='Fill Passenger Details',fg='black',bg='green',font="Arial 21 bold",borderwidth=1,relief="ridge").grid(row=0,column=0,columnspan=10,pady=15)
    ...
    def ticket(self):
        ...
        Label(Frame1,text='Online Bus Booking System',fg='Red',bg='orange',font="Arial 24 bold").pack()
        ...
        def exitt():
            a=showinfo('Message','Thank you have a nice day!')
            root.destroy()
        def home():
            root.destroy()
            self.menu()
        ...
        def checking(self):
            ...
            Label(Frame1,text='Online Bus Booking System',fg='black',bg='green',font="Arial 24 bold",borderwidth=1,relief="ridge").grid(row=1,column=0,columnspan=7,pady=10)
    ...
    def loginn(self):
        ...
        Label(Frame1,text='ADMIN LOGIN',fg='black',bg='green',font="Arial 24 bold",borderwidth=1,relief="ridge").grid(row=1,column=0,columnspan=10,pady=10)
    ...
    def operator(self):
        ...
        def add():
            ...
            if(oid.get()==""):
                ...
                for widget in Frame6.winfo_children():
                    widget.destroy()
                Label(Frame6,text='Record Added',fg='black',bg='green',font="Arial 18 bold",borderwidth=1,relief="ridge").grid(row=0,column=0,columnspan=10,pady=15)
        ...
        def edit():
            ...
            if(oid.get()==""):
                ...
                for widget in Frame6.winfo_children():
                    widget.destroy()
                Label(Frame6,text='Record Edited',fg='black',bg='green',font="Arial 18 bold",borderwidth=1,relief="ridge").grid(row=0,column=0,columnspan=10,pady=15)
        ...
        def show():
            ...
            if(p==[]):
                ...
                Label(Frame6,text='Requested Record',fg='black',bg='green',font="Arial 18 bold",borderwidth=1,relief="ridge").grid(row=0,column=0,columnspan=10,pady=15)
    ...
    def bus(self):
        ...
        def add():
            ...
            if(busid.get()==""):
                ...
                Label(Frame5,text='Record Added',fg='black',bg='green',font="Arial 18 bold",borderwidth=1,relief="ridge").grid(row=0,column=0,columnspan=10,pady=15)
        ...
        def show():
            ...
            Label(Frame5,text='Bus Info',fg='black',bg='green',font="Arial 18 bold",borderwidth=1,relief="ridge").grid(row=0,column=0,columnspan=10,pady=15)
    ...
    def route(self):
        ...
        def add():
            ...
            if(routeid.get()==""):
                ...
                Label(Frame6,text='Route Info',fg='black',bg='green',font="Arial 18 bold",borderwidth=1,relief="ridge").grid(row=0,column=0,columnspan=10,pady=15)
    ...
    def run(self):
        ...
        Frame2=Frame(root)
        Frame2.grid(row=3,column=0,columnspan=10)
        Label(Frame2,text="Online Bus Booking System ",fg="black",bg="light blue",font="Arial 16 bold",borderwidth=1,relief="ridge").grid(row=1,column=0,padx=400,columnspan=7)
        Label(root,text="").grid(row=4,column=0)
        ...
        def add():
            ...
            if(busids.get()==""):
                ...
                Label(Frame6,text='Added Record',fg='black',bg='green',font="Arial 18 bold",borderwidth=1,relief="ridge").grid(row=0,column=0,columnspan=10,pady=15)
